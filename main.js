...
function preload() {
    pingpongmiss = loadSound("missed.wav");
    pingpongtouchpaddle = loadSound("touchpaddle.wav");
}
...
function setup() {
    ...
    myvideo.size(700, 600);
    myvideo.hide();

    posenetmodel = ml5.poseNet(myvideo, modelLoaded);
    posenetmodel.on("pose", getPoses);
